...
public class MoveRestTests {
    ...
    void setUp() {
        ...
        //moveDTO = new MoveDTO(SAMPLE_ID, SAMPLE_MOVE_NAME, SAMPLE_DESC, userDTO);
...
//        // given
//        given(moveService.getMoveDTOById(moveDTO.getId())).willReturn(moveDTO);
//
//        // when
...
//
//        //then
//        then(moveService).should().getMoveDTOById(moveDTO.getId());
//    }
//
//    @Test
//    void whenMoveNotExist_thenReturnStatusNotFound() throws Exception {
//
//        given(moveService.getMoveDTOById(moveDTO.getId())).willThrow(new MoveNotFoundException(SAMPLE_ID));
//
//        mockMvc.perform(get("/api/moves/" + moveDTO.getId())
...
//                .andExpect(result -> assertEquals("id: " + SAMPLE_ID + " not found", Objects.isNull(result.getResolvedException()) ? "" : result.getResolvedException().getMessage()));
//
//        then(moveService).should().getMoveDTOById(SAMPLE_ID);
//
//    }
//
//    @Test
...
//
//    @Test
//    void whenMoveNotExtist_thenFailToUpdateMove() throws Exception {
//
...
//
//    @Test
//    void whenMoveNotExist_thenFailToDeleteMove() throws Exception {
//
//        willThrow(new MoveNotFoundException(SAMPLE_ID)).given(moveService).delete(SAMPLE_ID);
//
//        mockMvc.perform(delete("/api/moves/5")
//                .contentType(MediaType.APPLICATION_JSON)
//                .accept(MediaType.APPLICATION_JSON))
